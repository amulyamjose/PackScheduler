...
public class StudentDirectory {
	 ...
	 * @throws IllegalArgumentException "Unable to read file" if file is unable to
	 *                                  be read
	 */
	 ...
	 * false if
	 * the student is unable to be added because their id matches another student's
	 * id.
	 * 
	...
	/**
	 * gets a student from the directory by their id
	 * 
	 ...
	 * base64 encoding.
	 * This allows the encoded digest to be safely copied, as it only uses
	 * [a-zA-Z0-9+/=].
	 * 
	 * @param toHash the String to hash
	 * @return the encoded digest of the hash algorithm in base64
	 * @throws IllegalArgumentException "Invalid password" if the toHash is null
	 *                                  empty or
	 ...
	 * given id.
	 * Returns true if the student is removed and false if the student is not in the
	 * list.
	 * 
